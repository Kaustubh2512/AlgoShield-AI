      ...
      <style>
        {`
          ...
          .bento-card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(0, 255, 136, 0.15), 0 0 30px rgba(${glowColor}, 0.2);
          }
      ...
      >
        <div className="card-responsive grid gap-2">
          {displayCards.map((card, index) => {
            const baseClassName = `bento-card flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-colors duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
              ...
              return (
                ...
                >
                  <div className="card__header flex justify-between gap-3 relative text-white">
                    <span className="card__label text-xs font-mono text-primary tracking-wider">{card.label}</span>
                    {card.icon && <span className="text-primary">{card.icon}</span>}
                  </div>
                  <div className="card__content flex flex-col relative text-white">
                    <h3 className={`card__title font-syne font-bold text-lg m-0 mb-2 ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.title}
                    </h3>
                    <p
                      className={`card__description text-sm leading-5 text-gray-400 ${textAutoHide ? 'text-clamp-2' : ''}`}
                    >
                      {card.description}
                    </p>
                  </div>
            ...
            return (
              ...
              >
                ...
                <div className="card__content flex flex-col relative text-white">
                  ...
                  <p className={`card__description text-sm leading-5 text-gray-400 ${textAutoHide ? 'text-clamp-2' : ''}`}>
                    {card.description}
                  </p>
                </div>
              </div>
