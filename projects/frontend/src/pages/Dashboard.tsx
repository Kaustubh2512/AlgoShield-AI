...
import { Search, Award, Activity, History, ArrowRight, FileText, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        <motion.div 
          ...
          className="mb-8"
        >
          <Link to="/" className="inline-flex items-center gap-2 text-primary hover:text-white transition-colors mb-6 font-mono text-sm group">
