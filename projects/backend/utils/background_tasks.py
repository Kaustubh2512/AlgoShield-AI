...
NOTE: This is an alternative async implementation. The active monitoring
system uses services/monitor_service.py via APScheduler (app.py lifespan).
This file is kept as a reference for future async-only deployments.
